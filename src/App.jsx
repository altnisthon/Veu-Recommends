...
const PRODUCTS_DEFAULT = {
  "Spring Bright": [
    {id:"sb0",c:"Base",b:"Armani Beauty",n:"Luminous Silk Foundation",s:"4.5 Golden Beige",p:"$90–$110",l:"https://invl.me/clngldg",w:"Sephora SG / Robinsons",no:"Warm golden-beige; Spring Bright's skin needs a glow base not a matte one"},
    {id:"sb1",c:"Base",b:"TirTir",n:"Mask Fit Red Cushion",s:"17N Ivory",p:"$38–$45",l:"https://s.shopee.sg/9ALWfrwFC2",w:"Sephora / Shopee",no:"Light warm neutral; SPF40 cushion; best for Spring Bright's light clear skin"},
    {id:"sb2",c:"Base",b:"Clio",n:"Kill Cover Founwear Cushion",s:"01 Porcelain",p:"$28–$35",l:"https://invl.me/clngldk",w:"Guardian / Watsons",no:"Light warm shade; vivid coverage stays clear on Spring Bright skin"},
    {id:"sb3",c:"Blush",b:"Rare Beauty",n:"Soft Pinch Liquid Blush",s:"Joy",p:"$38–$45",l:"https://invl.me/clngle8",w:"Sephora SG",no:"Vivid coral — Spring Bright can carry saturated blush; soaked-in finish"},
    {id:"sb4",c:"Blush",b:"HERORANGE",n:"Liquid Blush Stick with Sponge Tip",s:"05 Coral Jelly",p:"$18–$28",l:"https://s.shopee.sg/4qCXWdUW7M",w:"Shopee",no:"Transparent water-gel; coral; the high-chroma blush Spring Bright needs"},
    {id:"sb5",c:"Blush",b:"Patrick Ta",n:"Major Headlines Double-Take Blush",s:"She's Coral",p:"$68–$80",l:"https://invl.me/clngleg",w:"Sephora SG",no:"Cream + powder duo; coral pigment for Spring Bright's vivid cheek"},
    {id:"sb6",c:"Blush",b:"Sephora Collection",n:"Blush & Go",s:"Puff (warm peachy-pink)",p:"$28–$35",l:"https://invl.me/clnglei",w:"Sephora SG",no:"Squeeze tube gel blush; warm peachy; Spring Bright's effortless glow"},
    {id:"sb7",c:"Eye",b:"3CE",n:"Multi Eye Color Palette",s:"Soft Petal",p:"$38–$48",l:"https://invl.me/clngleq",w:"Watsons",no:"Clear warm nudes for Spring Bright's everyday; satin pairs with bright lip"},
    {id:"sb8",c:"Eye",b:"Judydoll",n:"Six-Color Eyeshadow Palette",s:"02 Champagne Gold",p:"$15–$22",l:"https://s.shopee.sg/4LGGwCl73Y",w:"Shopee / Lazada",no:"Affordable warm gold glitter; huge on Xiaohongshu; vivid on Spring Bright"},
    {id:"sb9",c:"Eye",b:"NARS",n:"Total Seduction Eyeshadow Stick",s:"Warm Taupe",p:"$35–$42",l:"https://invl.me/clnglex",w:"Sephora SG",no:"1-step warm smoky; blurred grunge effect for Spring Bright's drama moment"},
    {id:"sb10",c:"Eye",b:"Ace Beauté",n:"Whimsical Bloom Palette",s:"Full palette",p:"$45–$60",l:"",w:"Shopee / Online",no:"Warm botanical brights; Spring Bright can wear vivid warm eye looks"},
    {id:"sb11",c:"Mascara",b:"NARS",n:"Climax Extreme Mascara",s:"Brown-Black",p:"$38–$45",l:"",w:"Sephora SG",no:"Brown-black warms Spring Bright's look; stark black too harsh on clear warm eyes"},
    {id:"sb12",c:"Brow",b:"Anastasia Beverly Hills",n:"Brow Wiz",s:"Caramel / Light Brunette",p:"$38–$48",l:"",w:"Sephora SG",no:"Light-medium warm brown; ABH 2026 comeback; Spring Bright's fluffy brow look"},
    {id:"sb13",c:"Lip",b:"Dior Beauty",n:"Addict Lip Glow Oil",s:"004 Coral",p:"$45–$55",l:"https://invl.me/clnglfc",w:"Sephora SG / DFS",no:"Warm coral tinted oil; Spring Bright's all-day lip with clear vibrancy"},
    {id:"sb14",c:"Lip",b:"Romand",n:"Juicy Lasting Tint",s:"04 Coral Sunrise",p:"$15–$22",l:"https://s.shopee.sg/6feBiwviY6",w:"Shopee",no:"Vivid warm coral tint; K-beauty staple; Spring Bright's accessible lip"},
    {id:"sb15",c:"Lip",b:"MAC Cosmetics",n:"Lustreglass Sheer-Shine Lipstick",s:"Dial Up Warmth",p:"$32–$42",l:"https://invl.me/clnglf7",w:"MAC / Sephora",no:"Warm peachy gloss; Y2K revival; Spring Bright's playful everyday lip"},
    {id:"sb16",c:"Lip",b:"Peripera",n:"Water Bare Tint",s:"CR701 Coral Petal",p:"$12–$18",l:"https://s.shopee.sg/40dQYFEDlg",w:"Shopee / Lazada",no:"Viral velvet; vivid warm coral; Spring Bright's budget bold lip"},
    {id:"sb17",c:"Lip",b:"Dior Beauty",n:"Rouge Dior On Stage",s:"028 Actrice",p:"$55–$70",l:"https://invl.me/clnglf1",w:"Sephora SG",no:"Vivid coral-red; Spring Bright can carry saturated brights — this is the bold lip"},
    {id:"sb18",c:"Highlight",b:"Charlotte Tilbury",n:"Hollywood Flawless Filter",s:"3 Warm Light",p:"$75–$90",l:"",w:"Sephora SG",no:"Warm golden glow filter; amplifies Spring Bright's natural radiance"},
    {id:"sb19",c:"Highlight",b:"Fenty Beauty",n:"Killawatt Freestyle Highlighter Duo",s:"Ginger Binge",p:"$42–$52",l:"https://invl.me/clnglem",w:"Sephora SG",no:"Warm gold metallic; Spring Bright's high-chroma highlight — vivid and clear"},
  ],
  "Spring Light": [
    {id:"sl0",c:"Base",b:"Laneige",n:"Water Blank Cushion",s:"21N Natural Beige",p:"$42–$52",l:"",w:"Sephora SG / Shopee",no:"Light warm neutral; dewy finish suits Spring Light's soft delicate skin"},
    {id:"sl1",c:"Base",b:"Canmake",n:"Mermaid Skin Gel UV SPF50+",s:"01 Clear",p:"$15–$22",l:"https://invl.me/clnglgy",w:"Watsons",no:"Lightweight SPF gel; Spring Light benefits from minimal coverage + protection"},
    {id:"sl2",c:"Base",b:"Huda Beauty",n:"Easy Blur Natural Airbrush Foundation",s:"2W Light Warm",p:"$55–$68",l:"https://invl.me/clnglh1",w:"Sephora SG",no:"Very light warm tint; skin-celebrating; Spring Light's ideal skin-positive base"},
    {id:"sl3",c:"Blush",b:"Judydoll",n:"Bare Water Blusher",s:"03 Spring Nap",p:"$18–$28",l:"https://s.shopee.sg/W3YPYqfHP",w:"Shopee",no:"Sheer warm peach water-blush; Spring Light needs soft not vivid blush"},
    {id:"sl4",c:"Blush",b:"Glossier",n:"Cloud Paint",s:"Dusk (soft warm peach)",p:"$28–$35",l:"",w:"Sephora SG",no:"Soft diffused warm peach; Spring Light's most natural blush expression"},
    {id:"sl5",c:"Blush",b:"Flower Knows",n:"Strawberry Rococo Blush",s:"01 Peach Parfait",p:"$22–$32",l:"https://s.shopee.sg/5VSEL8C5KO",w:"Shopee",no:"Soft peach; Xiaohongshu viral packaging; Spring Light's pretty daily blush"},
    {id:"sl6",c:"Blush",b:"3CE",n:"Blush",s:"Peach Splash",p:"$28–$38",l:"https://invl.me/clnglfr",w:"Watsons",no:"Soft warm peach powder; Spring Light's everyday cheek colour"},
    {id:"sl7",c:"Blush",b:"Benefit",n:"Dandelion Blush",s:"Baby Pink",p:"$48–$58",l:"https://invl.me/clnglh9",w:"Sephora SG",no:"Cult soft pink with warm shimmer; gentle on Spring Light's fair delicacy"},
    {id:"sl8",c:"Eye",b:"Urban Decay",n:"Naked 1 Palette",s:"All warm nudes",p:"$65–$80",l:"",w:"Sephora SG",no:"All warm neutral tones; Spring Light's go-to for soft everyday warm eye"},
    {id:"sl9",c:"Eye",b:"Peripera",n:"All Take Mood Palette",s:"01 Whisper of Spring Coral",p:"$38–$50",l:"https://invl.me/clnglfz",w:"Watsons",no:"Soft warm nudes by Korean MUA Pony; Spring Light's perfect daily palette"},
    {id:"sl10",c:"Eye",b:"ZEESEA",n:"9-Color Eyeshadow Palette",s:"Grapefruit Plate",p:"$18–$28",l:"https://s.shopee.sg/4Awql1QLUI",w:"Shopee",no:"Soft warm gold tones; Spring Light's accessible everyday palette"},
    {id:"sl11",c:"Mascara",b:"Benefit",n:"Roller Lash Mascara",s:"Brown-Black",p:"$42–$52",l:"",w:"Sephora SG",no:"Curling; brown-black is softer than black for Spring Light's gentle look"},
    {id:"sl12",c:"Brow",b:"3CE",n:"Eyebrow Pencil",s:"01 Light Brown",p:"$18–$25",l:"",w:"Sephora / Shopee",no:"Light warm brown; Spring Light's brows should be soft, not defined too strongly"},
    {id:"sl13",c:"Lip",b:"Charlotte Tilbury",n:"Matte Revolution",s:"Very Victoria",p:"$48–$60",l:"https://invl.me/clnglgc",w:"Sephora SG",no:"Peachy warm nude; Spring Light's signature lip — never too vivid or cool"},
    {id:"sl14",c:"Lip",b:"Romand",n:"Glasting Water Gloss",s:"01 Sanho Crush",p:"$15–$22",l:"",w:"Shopee",no:"Glass-like warm peach; Spring Light's lip should be soft and dewy, not bold"},
    {id:"sl15",c:"Lip",b:"Dior Beauty",n:"Addict Lip Glow Oil",s:"087 Spicy",p:"$45–$55",l:"https://invl.me/clnglgt",w:"Sephora SG",no:"Warm peachy oil; delicate iridescence suits Spring Light's soft aesthetic"},
    {id:"sl16",c:"Lip",b:"Flower Knows",n:"Shell's Jewel Nourishing Lip Glaze",s:"P09 Coral Conch",p:"$10–$16",l:"https://s.shopee.sg/1LcfOY2weV",w:"Shopee",no:"Affordable warm peach gloss; Spring Light's budget everyday lip"},
    {id:"sl17",c:"Highlight",b:"Becca",n:"Shimmering Skin Perfector",s:"Champagne Pop",p:"$42–$55",l:"",w:"Sephora SG",no:"Soft warm gold; Spring Light needs a delicate not overpowering highlight"},
  ],
  "Summer Light": [
    {id:"suml0",c:"Base",b:"Chanel Beauty",n:"Les Beiges Water-Fresh Tint",s:"Light cool-neutral",p:"$80–$95",l:"",w:"Chanel / Sephora",no:"Sheer and cool-neutral; Summer Light's fair complexion needs minimal base"},
    {id:"suml1",c:"Base",b:"Laneige",n:"Water Blank Cushion",s:"21C Cool Ivory",p:"$42–$52",l:"",w:"Sephora SG / Shopee",no:"Cool-toned ivory; dewy cushion; Summer Light's go-to K-beauty base"},
    {id:"suml2",c:"Base",b:"Eborian",n:"CC Cream SPF50",s:"Fair (cool)",p:"$35–$48",l:"",w:"Sephora SG",no:"Cool fair tone; lightweight perfect for Summer Light's SG climate"},
    {id:"suml3",c:"Blush",b:"Rare Beauty",n:"Soft Pinch Liquid Blush",s:"Hope",p:"$38–$45",l:"",w:"Sephora SG",no:"Soft cool rose; Summer Light's blush should be whisper-light, never vivid"},
    {id:"suml4",c:"Blush",b:"NARS",n:"Afterglow Blush",s:"Deep Throat",p:"$45–$55",l:"",w:"Sephora SG",no:"Soft cool pink shimmer; Summer Light's ethereal glow cheek"},
    {id:"suml5",c:"Blush",b:"Flower Knows",n:"Strawberry Rococo Blush",s:"05 Lavender Mist",p:"$22–$32",l:"",w:"Shopee",no:"Soft lavender-pink; Summer Light's most delicate colour expression"},
    {id:"suml6",c:"Blush",b:"Milk Makeup",n:"Cooling Water Jelly Tint",s:"Poppy",p:"$32–$42",l:"",w:"Sephora SG",no:"Cool jelly; refreshing texture; Summer Light's airy skin aesthetic"},
    {id:"suml7",c:"Blush",b:"RMK",n:"Creamy Cheek Colour",s:"04 Sheer Rose",p:"$42–$52",l:"",w:"Tangs / Isetan",no:"Cult Japanese cream; cool sheer rose; Summer Light's skin-blended cheek"},
    {id:"suml8",c:"Eye",b:"Charlotte Tilbury",n:"Pillow Talk Eyeshadow Palette",s:"Full palette",p:"$75–$92",l:"",w:"Sephora SG",no:"Cool pinks, mauves; Summer Light's signature eye palette — soft and ethereal"},
    {id:"suml9",c:"Eye",b:"Kate",n:"The Eye Color",s:"06 Lavender Mauve",p:"$12–$18",l:"",w:"Watsons / Shopee",no:"Single pan lavender; the 2026 soft purple eye trend; very affordable"},
    {id:"suml10",c:"Eye",b:"ZEESEA",n:"British Museum Collab Palette",s:"Rose Garden",p:"$18–$28",l:"",w:"Shopee",no:"Cool dusty pink tones; Summer Light's Chinese brand palette pick"},
    {id:"suml11",c:"Mascara",b:"Shiseido",n:"Full Lash Volume Mascara",s:"01 Black",p:"$38–$48",l:"",w:"Tangs / Isetan",no:"Gentle formula; Summer Light's lashes are often light — volume without harshness"},
    {id:"suml12",c:"Brow",b:"Kate",n:"Designing Eyebrow 3D",s:"EX-4 Ash Brown",p:"$12–$18",l:"",w:"Watsons / Shopee",no:"Ash brown for cool tones; Summer Light's brows should be soft and cool-toned"},
    {id:"suml13",c:"Lip",b:"Dior Beauty",n:"Addict Lip Glow Oil",s:"063 Pink Lilac",p:"$45–$55",l:"",w:"Sephora SG",no:"Sheer cool lilac; Summer Light's lip should be airy, not vivid — this is perfect"},
    {id:"suml14",c:"Lip",b:"Romand",n:"Glasting Melting Balm",s:"01 Bare Pink",p:"$15–$22",l:"",w:"Shopee",no:"Sheer cool pink balm; Summer Light's go-to daily lip — nothing too saturated"},
    {id:"suml15",c:"Lip",b:"Charlotte Tilbury",n:"Lip Lustre",s:"Pillow Talk",p:"$48–$60",l:"",w:"Sephora SG",no:"Soft cool mauve with lustre; Summer Light's elevated everyday lip"},
    {id:"suml16",c:"Lip",b:"Etude",n:"Fixing Tint",s:"PK001 Pale Cool Pink",p:"$12–$18",l:"",w:"Shopee / Watsons",no:"Cool pale pink; accessible; Summer Light's budget everyday tint"},
    {id:"suml17",c:"Highlight",b:"Becca",n:"Shimmering Skin Perfector",s:"Moonstone",p:"$42–$55",l:"",w:"Sephora SG",no:"Pearl-cool highlight; Summer Light's icy luminous glow — never warm gold"},
  ],
  "Summer Mute": [
    {id:"summ0",c:"Base",b:"Charlotte Tilbury",n:"Airbrush Flawless Foundation",s:"5 Cool",p:"$80–$95",l:"",w:"Sephora SG",no:"Cool medium; matte-satin finish suits Summer Mute's sophisticated muted aesthetic"},
    {id:"summ1",c:"Base",b:"Laneige",n:"Neo Cushion Matte",s:"23C Cool",p:"$48–$58",l:"",w:"Sephora SG / Shopee",no:"Cool matte cushion; Summer Mute's skin tone benefits from less shine"},
    {id:"summ2",c:"Base",b:"Shu Uemura",n:"Unlimited Fluid Foundation",s:"144 Cool Medium",p:"$75–$90",l:"",w:"Tangs / Isetan",no:"Japanese craftsmanship; cool medium; Summer Mute's precision choice"},
    {id:"summ3",c:"Blush",b:"Rare Beauty",n:"Soft Pinch Liquid Blush",s:"Believe",p:"$38–$45",l:"",w:"Sephora SG",no:"Muted mauve; Summer Mute's blush must be dusty/muted — never vivid"},
    {id:"summ4",c:"Blush",b:"Chanel Beauty",n:"Les Beiges Healthy Glow Blush",s:"21 Dusty Rose",p:"$75–$90",l:"",w:"Chanel / Sephora",no:"Dusty cool rose; Summer Mute's signature elevated blush"},
    {id:"summ5",c:"Blush",b:"NARS",n:"Blush",s:"Lovejoy",p:"$45–$55",l:"",w:"Sephora SG",no:"Muted cool pink powder; Summer Mute's everyday cheek colour"},
    {id:"summ6",c:"Blush",b:"Flower Knows",n:"Strawberry Rococo Blush",s:"03 Rose Petal",p:"$22–$32",l:"",w:"Shopee",no:"Cool muted rose; accessible; Summer Mute's Chinese brand pick"},
    {id:"summ7",c:"Blush",b:"Milk Makeup",n:"Cooling Water Jelly Tint",s:"Bitten",p:"$32–$42",l:"",w:"Sephora SG",no:"Cool muted rose gel; Summer Mute's refreshing cheek for SG climate"},
    {id:"summ8",c:"Eye",b:"Urban Decay",n:"Naked 3 Palette",s:"Full cool rose-mauve",p:"$65–$80",l:"",w:"Sephora SG",no:"All cool rose-mauve-grey tones; Summer Mute's definitive everyday palette"},
    {id:"summ9",c:"Eye",b:"Charlotte Tilbury",n:"Pillow Talk Eyeshadow Palette",s:"Muted cool pinks + grey-taupes",p:"$75–$92",l:"",w:"Sephora SG",no:"Muted cool pinks and grey-taupes; Summer Mute's romantic eye"},
    {id:"summ10",c:"Eye",b:"ZEESEA",n:"British Museum Collab Palette",s:"Mauve Archives",p:"$18–$28",l:"",w:"Shopee",no:"Muted cool tones; affordable Summer Mute palette"},
    {id:"summ11",c:"Mascara",b:"Shiseido",n:"Controlled Chaos Mascaraink",s:"01 Black Pulse",p:"$38–$48",l:"",w:"Tangs / Isetan / Sephora",no:"Neutral mascara; Summer Mute's lash volume without clumping"},
    {id:"summ12",c:"Brow",b:"Anastasia Beverly Hills",n:"Brow Wiz",s:"Ash Brown",p:"$38–$48",l:"",w:"Sephora SG",no:"Ash brown; ABH 2026 comeback; Summer Mute's cool-toned brow"},
    {id:"summ13",c:"Lip",b:"Charlotte Tilbury",n:"Matte Revolution",s:"Pillow Talk",p:"$48–$60",l:"",w:"Sephora SG",no:"THE Summer Mute lip; cool muted mauve — the 2026 mauve trend is made for this season"},
    {id:"summ14",c:"Lip",b:"Dior Beauty",n:"Addict Lip Glow Oil",s:"001 Pink",p:"$45–$55",l:"",w:"Sephora SG",no:"Sheer cool pink oil; Summer Mute's everyday low-key lip"},
    {id:"summ15",c:"Lip",b:"Romand",n:"Blur Fudge Tint",s:"10 Mauve Daily",p:"$15–$22",l:"",w:"Shopee",no:"Muted mauve blur tint; Summer Mute's most season-accurate K-beauty lip"},
    {id:"summ16",c:"Lip",b:"L'Oréal Paris",n:"Colour Riche Intense Volume Matte",s:"Blush Fantasy",p:"$22–$32",l:"",w:"Watsons / Guardian",no:"Cool muted pink; accessible one-accent lip for Summer Mute"},
    {id:"summ17",c:"Lip",b:"Shu Uemura",n:"Rouge Unlimited Matte",s:"PK355 Dusty Pink",p:"$48–$60",l:"",w:"Tangs / Isetan",no:"Cool dusty pink; Japanese matte formula; Summer Mute's elevated muted lip"},
    {id:"summ18",c:"Highlight",b:"NARS",n:"Illuminator",s:"Orgasm (cool rose shimmer)",p:"$48–$58",l:"",w:"Sephora SG",no:"Subtle cool rose shimmer; Summer Mute's highlight is never blazing — a soft glow"},
  ],
  "Autumn Mute": [
    {id:"am0",c:"Base",b:"Fenty Beauty",n:"Pro Filt'r Soft Matte Foundation",s:"350W Warm Medium",p:"$50–$65",l:"",w:"Sephora SG",no:"Warm 350W; matte suits Autumn Mute's earthy muted aesthetic"},
    {id:"am1",c:"Base",b:"Bobbi Brown",n:"Skin Long-Wear Weightless Foundation",s:"W-044 Honey Warm",p:"$68–$82",l:"",w:"Sephora SG / TANGS",no:"Honey warm shade; natural finish; Autumn Mute's polished everyday base"},
    {id:"am2",c:"Base",b:"Clio",n:"Kill Cover Mesh Glow Cushion",s:"03 Lingerie Warm",p:"$28–$38",l:"",w:"Watsons / Shopee",no:"Warm lingerie tone; muted glow mesh finish suits Autumn Mute's earthy skin"},
    {id:"am3",c:"Blush",b:"Rare Beauty",n:"Soft Pinch Liquid Blush",s:"Grateful",p:"$38–$45",l:"",w:"Sephora SG",no:"Warm terracotta; muted not vivid — correct for Autumn Mute's low chroma season"},
    {id:"am4",c:"Blush",b:"Charlotte Tilbury",n:"Cheek to Chic Blush",s:"Hepburn Honeymoon",p:"$60–$72",l:"",w:"Sephora SG",no:"Warm terracotta powder duo; buildable earthy flush for Autumn Mute"},
    {id:"am5",c:"Blush",b:"NARS",n:"Blush",s:"Torrid",p:"$45–$55",l:"",w:"Sephora SG",no:"Warm coral-brick; classic NARS for Autumn Mute's warm cheek"},
    {id:"am6",c:"Blush",b:"Judydoll",n:"Cloud Nine Blush",s:"05 Terracotta Bloom",p:"$12–$18",l:"",w:"Shopee",no:"Affordable viral terracotta; Autumn Mute's budget blush option"},
    {id:"am7",c:"Blush",b:"Flower Knows",n:"Strawberry Rococo Blush",s:"07 Amber Honey",p:"$22–$32",l:"",w:"Shopee",no:"Warm amber-honey tone; Xiaohongshu favourite; Autumn Mute pick"},
    {id:"am8",c:"Eye",b:"Anastasia Beverly Hills",n:"Soft Glam Palette",s:"Russet / Amber / Sienna",p:"$68–$82",l:"",w:"Sephora SG",no:"Warm rust-amber-sienna; muted warm tones; Autumn Mute's perfect everyday palette"},
    {id:"am9",c:"Eye",b:"Urban Decay",n:"Naked Heat Palette",s:"Full amber-bronze-rust",p:"$65–$80",l:"",w:"Sephora SG",no:"All warm muted tones; Autumn Mute lives in this palette"},
    {id:"am10",c:"Eye",b:"Romand",n:"Better Than Palette",s:"BE01 Butternut Latte",p:"$25–$35",l:"",w:"Shopee",no:"Warm nude-butterscotch tones; Autumn Mute's K-beauty palette"},
    {id:"am11",c:"Eye",b:"Florasis",n:"Ancient City Eye Palette",s:"03 Autumn Harvest",p:"$28–$40",l:"",w:"Shopee",no:"Autumn-inspired warm muted tones; big on Xiaohongshu; season-accurate"},
    {id:"am12",c:"Mascara",b:"Benefit",n:"They're Real Mascara",s:"Black",p:"$42–$52",l:"",w:"Sephora SG",no:"Lengthening mascara for Autumn Mute's subtle dramatic look"},
    {id:"am13",c:"Brow",b:"Benefit",n:"Precisely My Brow Pencil",s:"03 Warm Light Brown",p:"$42–$52",l:"",w:"Sephora SG",no:"Warm light-medium brown; Autumn Mute's brow should be earthy, not dark"},
    {id:"am14",c:"Lip",b:"MAC Cosmetics",n:"Matte Lipstick",s:"Twig",p:"$32–$42",l:"",w:"MAC / Sephora",no:"Warm muted nude; Autumn Mute's most season-correct everyday lip — earthy not vivid"},
    {id:"am15",c:"Lip",b:"Romand",n:"Zero Velvet Tint",s:"13 Autumn",p:"$15–$22",l:"",w:"Shopee",no:"Warm muted berry velvet; Autumn Mute's Korean lip pick — earthy depth"},
    {id:"am16",c:"Lip",b:"Charlotte Tilbury",n:"Matte Revolution",s:"Pillow Talk Intense",p:"$48–$60",l:"",w:"Sephora SG",no:"Warm muted rose; Autumn Mute's lip should stay in muted warm territory"},
    {id:"am17",c:"Lip",b:"NYX Professional",n:"Lip Lingerie XXL Matte",s:"Spicy",p:"$15–$22",l:"",w:"Watsons / Guardian",no:"Warm muted terracotta nude; accessible Autumn Mute lip"},
    {id:"am18",c:"Highlight",b:"Charlotte Tilbury",n:"Hollywood Flawless Filter",s:"5 Medium Warm",p:"$75–$90",l:"",w:"Sephora SG",no:"Medium warm filter; Autumn Mute's glow is earthy not flashy"},
  ],
  "Autumn Deep": [
    {id:"ad0",c:"Base",b:"Fenty Beauty",n:"Pro Filt'r Soft Matte Foundation",s:"370W Deep Warm",p:"$50–$65",l:"",w:"Sephora SG",no:"Best-in-class deep warm shades; matte aligns with Autumn Deep's bold 2026 look"},
    {id:"ad1",c:"Base",b:"NARS",n:"Natural Radiant Longwear Foundation",s:"Syracuse",p:"$68–$80",l:"",w:"Sephora SG",no:"Warm deep shade; luminous longevity; Autumn Deep's drama base"},
    {id:"ad2",c:"Base",b:"Make Up For Ever",n:"HD Skin Foundation",s:"3Y38 Warm Deep",p:"$65–$80",l:"",w:"Sephora SG / TANGS",no:"Professional-grade; excellent warm deep shade range for Autumn Deep"},
    {id:"ad3",c:"Blush",b:"Rare Beauty",n:"Soft Pinch Liquid Blush",s:"Lucky",p:"$38–$45",l:"",w:"Sephora SG",no:"Warm brick; Autumn Deep can carry richer, more saturated blush than Autumn Mute"},
    {id:"ad4",c:"Blush",b:"Charlotte Tilbury",n:"Filmstar Bronze & Glow",s:"Medium-Deep",p:"$80–$95",l:"",w:"Sephora SG",no:"Bronze-to-glow duo; the sun-kissed cheek is Autumn Deep's power move"},
    {id:"ad5",c:"Blush",b:"NARS",n:"Laguna Bronzer",s:"Laguna",p:"$45–$55",l:"",w:"Sephora SG",no:"Warm bronze swept high into temples; Autumn Deep's editorial cheek"},
    {id:"ad6",c:"Blush",b:"Hourglass",n:"Ambient Lighting Blush",s:"Radiant Magenta",p:"$68–$82",l:"",w:"Sephora SG",no:"Warm red-toned ambient powder; Autumn Deep's elevated blush pick"},
    {id:"ad7",c:"Blush",b:"Judydoll",n:"Cloud Nine Blush",s:"08 Sienna",p:"$12–$18",l:"",w:"Shopee",no:"Affordable viral sienna blush; Autumn Deep's budget-friendly cheek"},
    {id:"ad8",c:"Eye",b:"Anastasia Beverly Hills",n:"Soft Glam Palette",s:"Cyprus Umber / Russet / Sienna",p:"$68–$82",l:"",w:"Sephora SG",no:"ABH 2026 comeback; richest deep warm palette for Autumn Deep's cut crease"},
    {id:"ad9",c:"Eye",b:"Tom Ford Beauty",n:"Eye Color Quad",s:"Cocoa Mirage",p:"$90–$110",l:"",w:"Sephora SG",no:"Premium warm deep quad; Autumn Deep's luxury dramatic eye"},
    {id:"ad10",c:"Eye",b:"Pat McGrath Labs",n:"Mothership VI",s:"Midnight Sun",p:"$85–$105",l:"",w:"Sephora SG",no:"Ultra-pigmented deep warm; Autumn Deep's maximalist palette pick"},
    {id:"ad11",c:"Eye",b:"Florasis",n:"Blooming Rouge Palette",s:"02 Autumn Gold",p:"$28–$40",l:"",w:"Shopee",no:"Xiaohongshu cult; Autumn-inspired deep warm golds for Autumn Deep"},
    {id:"ad12",c:"Mascara",b:"Hourglass",n:"Unlocked Instant Extensions Mascara",s:"Black",p:"$52–$65",l:"",w:"Sephora SG",no:"Extension effect; Autumn Deep's bold dramatic eye needs a statement mascara"},
    {id:"ad13",c:"Brow",b:"Anastasia Beverly Hills",n:"Brow Definer",s:"Deep Brown",p:"$38–$48",l:"",w:"Sephora SG",no:"ABH 2026 comeback; deep warm brown brow for Autumn Deep's bold face"},
    {id:"ad14",c:"Lip",b:"MAC Cosmetics",n:"Retro Matte Liquid Lipcolour",s:"Carnivorous",p:"$35–$45",l:"",w:"MAC / Sephora",no:"Vivid warm brick-red; Autumn Deep can carry saturation — this is their 2026 bold lip"},
    {id:"ad15",c:"Lip",b:"Tom Ford Beauty",n:"Lip Stylo Matte",s:"Impassioned",p:"$65–$80",l:"",w:"Sephora SG",no:"Oxblood is Autumn Deep's heritage colour — the 2026 bold lip return is made for them"},
    {id:"ad16",c:"Lip",b:"Dior Beauty",n:"Rouge Dior On Stage",s:"943 Euphoric",p:"$55–$70",l:"",w:"Sephora SG",no:"Warm deep burgundy; Dior's long-wear comfort for Autumn Deep's drama lip"},
    {id:"ad17",c:"Lip",b:"Florasis",n:"Blooming Rouge Lipstick",s:"08 Deep Autumn",p:"$25–$38",l:"",w:"Shopee",no:"Florasis warm deep; Xiaohongshu cult lipstick; Autumn Deep's Chinese brand pick"},
    {id:"ad18",c:"Highlight",b:"Fenty Beauty",n:"Killawatt Highlighter",s:"Lightning Dust (copper-gold)",p:"$42–$52",l:"",w:"Sephora SG",no:"Copper-gold highlight; Autumn Deep's metallic is copper not gold or silver"},
  ],
  "Winter Bright": [
    {id:"wb0",c:"Base",b:"Giorgio Armani",n:"Luminous Silk Foundation",s:"6 Medium Cool",p:"$90–$110",l:"",w:"Sephora SG",no:"Cool medium; luminous return trend 2026; Winter Bright's crisp luminous base"},
    {id:"wb1",c:"Base",b:"NARS",n:"Natural Radiant Longwear Foundation",s:"Alaska",p:"$68–$80",l:"",w:"Sephora SG",no:"Cool fair Alaska; radiant finish; Winter Bright's luminous high-contrast base"},
    {id:"wb2",c:"Base",b:"Charlotte Tilbury",n:"Airbrush Flawless Foundation",s:"1 Cool",p:"$80–$95",l:"",w:"Sephora SG",no:"Cool fair; 24hr wear; Winter Bright's high-contrast base needs precision"},
    {id:"wb3",c:"Blush",b:"Charlotte Tilbury",n:"Cheek to Chic Blush",s:"Love Is The Drug",p:"$60–$72",l:"",w:"Sephora SG",no:"Vivid cool rose; Winter Bright's high-chroma blush — graphic placement, bold colour"},
    {id:"wb4",c:"Blush",b:"MAC Cosmetics",n:"Glow Play Blush",s:"That's Cheeky",p:"$38–$48",l:"",w:"MAC / Sephora",no:"Vivid cool pink; Winter Bright can carry saturated vivid blush placed graphically high"},
    {id:"wb5",c:"Blush",b:"NARS",n:"Blush",s:"Orgasm",p:"$45–$55",l:"",w:"Sephora SG",no:"Cool silver-pink shimmer; Winter Bright's luminous vivid cheek"},
    {id:"wb6",c:"Blush",b:"Givenchy",n:"Prisme Libre Blush",s:"06 Lilas Evanescent",p:"$70–$85",l:"",w:"Sephora SG",no:"Vivid cool lilac loose powder; Winter Bright's French luxury cheek pick"},
    {id:"wb7",c:"Blush",b:"Romand",n:"Bare Water Blusher",s:"09 Mauve Haze",p:"$18–$28",l:"",w:"Shopee",no:"Cool vivid water blusher; budget-accessible Winter Bright blush"},
    {id:"wb8",c:"Eye",b:"Pat McGrath Labs",n:"Mothership Eyeshadow",s:"Midnight Sun",p:"$85–$105",l:"",w:"Sephora SG",no:"Pat McGrath 2026 artistry; cool metallics for Winter Bright's vivid eye statement"},
    {id:"wb9",c:"Eye",b:"Anastasia Beverly Hills",n:"Norvina Pro Pigment Vol. 5",s:"Icy Lilac / Cobalt / Silver",p:"$75–$92",l:"",w:"Sephora SG",no:"ABH 2026 comeback; vivid cool cut crease for Winter Bright — the season's eye moment"},
    {id:"wb10",c:"Eye",b:"Urban Decay",n:"Naked Reloaded Palette",s:"Cool taupes / silvers",p:"$65–$80",l:"",w:"Sephora SG",no:"Cool neutral tones; Winter Bright's versatile everyday palette"},
    {id:"wb11",c:"Mascara",b:"Urban Decay",n:"Perversion Mascara",s:"Black",p:"$38–$48",l:"",w:"Sephora SG",no:"True black volume; Winter Bright's non-negotiable mascara"},
    {id:"wb12",c:"Brow",b:"Anastasia Beverly Hills",n:"Brow Wiz",s:"Taupe / Ash Brown",p:"$38–$48",l:"",w:"Sephora SG",no:"Cool taupe or ash; ABH 2026 comeback; Winter Bright's precise bold brow"},
    {id:"wb13",c:"Lip",b:"MAC Cosmetics",n:"Ruby Woo Lipstick",s:"Ruby Woo",p:"$32–$42",l:"",w:"MAC / Sephora",no:"THE cool red — blue-based; Winter Bright's definitive bold lip; the 2026 true red moment"},
    {id:"wb14",c:"Lip",b:"Tom Ford Beauty",n:"Lip Colour Ultra-Rich",s:"Forbidden Pink",p:"$58–$72",l:"",w:"Sephora SG",no:"Vivid cool fuchsia; Winter Bright's maximalist saturated pink lip moment"},
    {id:"wb15",c:"Lip",b:"Dior Beauty",n:"Rouge Dior",s:"080 Red Smile",p:"$55–$70",l:"",w:"Sephora SG",no:"Blue-based cool red; Dior's vivid classic for Winter Bright's red lip moment"},
    {id:"wb16",c:"Lip",b:"L'Oréal Paris",n:"Infallible Matte Resistance",s:"Bilingual",p:"$18–$25",l:"",w:"Watsons / Guardian",no:"16hr matte; vivid cool plum; Winter Bright's accessible bold lip option"},
    {id:"wb17",c:"Lip",b:"Romand",n:"Zero Velvet Tint",s:"07 Fig",p:"$15–$22",l:"",w:"Shopee",no:"Cool fig-plum velvet; Winter Bright's K-beauty lip — vivid cool depth"},
    {id:"wb18",c:"Highlight",b:"Pat McGrath Labs",n:"Skin Show Highlighter",s:"Silver Subliminal",p:"$68–$82",l:"",w:"Sephora SG",no:"Cool vivid silver; Winter Bright's highlight is always cool and striking — never warm"},
  ],
  "Winter Dark": [
    {id:"wd0",c:"Base",b:"NARS",n:"Natural Radiant Longwear Foundation",s:"Macao",p:"$68–$80",l:"",w:"Sephora SG",no:"Cool deep; luminous longevity; Winter Dark's authority base"},
    {id:"wd1",c:"Base",b:"Fenty Beauty",n:"Pro Filt'r Soft Matte Foundation",s:"490 Deep Cool",p:"$50–$65",l:"",w:"Sephora SG",no:"Deep cool 490; matte for Winter Dark's high-contrast clarity"},
    {id:"wd2",c:"Base",b:"Pat McGrath Labs",n:"Skin Fetish Foundation",s:"Deep 45 Cool",p:"$80–$100",l:"",w:"Sephora SG",no:"Pat McGrath = 2026 artistry brand; cool deep perfection for Winter Dark"},
    {id:"wd3",c:"Blush",b:"MAC Cosmetics",n:"Glow Play Blush",s:"Berry Shake",p:"$38–$48",l:"",w:"MAC / Sephora",no:"Vivid cool berry; Winter Dark's high-chroma cheek — graphic, high-placed"},
    {id:"wd4",c:"Blush",b:"Charlotte Tilbury",n:"Cheek to Chic Blush",s:"Sex On The Rocks",p:"$60–$72",l:"",w:"Sephora SG",no:"Cool deep rose duo; buildable from day to editorial for Winter Dark"},
    {id:"wd5",c:"Blush",b:"NARS",n:"Afterglow Blush",s:"Orgasm",p:"$45–$55",l:"",w:"Sephora SG",no:"Cool silver-pink shimmer on Winter Dark's high cheekbones — lit and lifted"},
    {id:"wd6",c:"Blush",b:"Hourglass",n:"Ambient Lighting Blush",s:"Vivid",p:"$68–$82",l:"",w:"Sephora SG",no:"Vivid fuchsia; only Winter Dark can carry this with full authority and gravity"},
    {id:"wd7",c:"Eye",b:"Pat McGrath Labs",n:"Mothership I Dark Star",s:"Deep cool metals",p:"$85–$105",l:"",w:"Sephora SG",no:"Pat McGrath maximalist; deep cool metallics for Winter Dark's drama eye"},
    {id:"wd8",c:"Eye",b:"Anastasia Beverly Hills",n:"Norvina Pro Pigment Vol. 5",s:"Cobalt / Deep Violet / Silver",p:"$75–$92",l:"",w:"Sephora SG",no:"ABH 2026 comeback; Winter Dark's cut crease palette — cobalt and deep violet"},
    {id:"wd9",c:"Eye",b:"Melt Cosmetics",n:"Gemini Eye Palette",s:"Sapphire / Onyx / Chrome",p:"$52–$65",l:"",w:"Online",no:"Bold cool metallics; Winter Dark's dramatic palette"},
    {id:"wd10",c:"Eye",b:"Urban Decay",n:"Heavy Metal Glitter Liner",s:"Midnight Cowboy (cool silver)",p:"$22–$30",l:"",w:"Sephora SG",no:"Cool silver glitter; Winter Dark's iridescent eye statement — silver not gold"},
    {id:"wd11",c:"Mascara",b:"Urban Decay",n:"Perversion Mascara",s:"Black",p:"$38–$48",l:"",w:"Sephora SG",no:"True black; Winter Dark's mascara is non-negotiable black — no brown-black"},
    {id:"wd12",c:"Brow",b:"Anastasia Beverly Hills",n:"Brow Definer",s:"Dark Brown / Ebony",p:"$38–$48",l:"",w:"Sephora SG",no:"ABH 2026 comeback; dark cool brown or ebony for Winter Dark's strong brow"},
    {id:"wd13",c:"Lip",b:"MAC Cosmetics",n:"Ruby Woo Lipstick",s:"Ruby Woo",p:"$32–$42",l:"",w:"MAC / Sephora",no:"THE cool red — blue-based; Winter Dark's definitive bold lip"},
    {id:"wd14",c:"Lip",b:"Tom Ford Beauty",n:"Lip Colour Ultra-Rich",s:"Black Orchid",p:"$58–$72",l:"",w:"Sephora SG",no:"Deep cool plum; Winter Dark's luxury one-accent statement lip"},
    {id:"wd15",c:"Lip",b:"Charlotte Tilbury",n:"Matte Revolution",s:"Bond Girl",p:"$48–$60",l:"",w:"Sephora SG",no:"Cool deep berry; Winter Dark's elegant bold lip option"},
    {id:"wd16",c:"Lip",b:"Romand",n:"Zero Velvet Tint",s:"09 Dry Plum",p:"$15–$22",l:"",w:"Shopee",no:"Cool deep plum velvet; budget Winter Dark lip — very accessible SG"},
    {id:"wd17",c:"Lip",b:"L'Oréal Paris",n:"Infallible Matte Resistance",s:"Midnight Roses",p:"$18–$25",l:"",w:"Watsons / Guardian",no:"16hr matte; deep cool berry; accessible Winter Dark bold lip"},
    {id:"wd18",c:"Highlight",b:"NARS",n:"Highlighting Powder Palette",s:"Subculture (cool silver)",p:"$65–$80",l:"",w:"Sephora SG",no:"Cool silver; Winter Dark's highlight is always cool — never gold"},
  ],
};
...
function RichText({ text }) {
  ...
  while ((m = linkRe.exec(text)) !== null) {
    if (m.index > last) out.push(...renderInlineText(text.slice(last, m.index), `p${last}`));
    out.push(<a key={`lnk${m.index}`} href={m[2]} target="_blank" rel="noopener noreferrer" style={{color:'#932D28',fontWeight:600,textDecoration:'underline'}}>{m[1]}</a>);
    last = m.index + m[0].length;
  }
  if (last < text.length) out.push(...renderInlineText(text.slice(last), `p${last}`));
  return <>{out}</>;
}
...
function AdminPanel({ products, onSave, onClose }) {
  ...
  const handleSaveAll = () => { onSave(localProds); onClose(); };
      ...
      <div style={{background:'#FDFAF7',borderRadius:12,width:'100%',maxWidth:900,maxHeight:'90vh',overflow:'hidden',display:'flex',flexDirection:'column',boxShadow:'0 20px 60px rgba(0,0,0,0.3)'}}>
        ...
        <div style={{background:'#932D28',color:'#fff',padding:'16px 20px',display:'flex',justifyContent:'space-between',alignItems:'center',flexShrink:0}}>
          ...
          <div style={{display:'flex',gap:10,alignItems:'center'}}>
            <button onClick={handleSaveAll} style={{background:'#fff',color:'#932D28',border:'none',borderRadius:6,padding:'7px 16px',fontSize:11,fontWeight:700,cursor:'pointer',letterSpacing:'0.08em'}}>SAVE & CLOSE</button>
          ...
          <table style={{width:'100%',borderCollapse:'collapse',fontSize:11}}>
            <thead>
              <tr style={{background:'#F9F5F2'}}>
                {['Cat','Brand','Product','Shade','Price','Where','Link','Notes / Why It Works',''].map(h=>(
...
export default function App() {
  ...
  const ADMIN_PASSWORD = 'veu2026'; // change this to your preferred password
  ...
  useEffect(() => {
    (async () => {
      try {
        const r = await window.storage.get('veu_products_v2');
        if (r?.value) setProducts(JSON.parse(r.value));
      } catch {}
      setReady(true);
    })();
  }, []);
  ...
  const saveProducts = async (p) => {
    setProducts(p);
    try { await window.storage.set('veu_products_v2', JSON.stringify(p)); } catch {}
  };
...
RULES:
- Recommend exactly 2 products per message, then ask if they want more or want to switch category
- The user may ask about any category at any point — lips after blush, eyes after foundation, anything. Always follow what they ask for, do not stay locked to the initial pick
- Format each pick on its own line: **Brand Product** in Shade (~price) · where to buy · [Shop →](link) if link exists · one sentence why it suits their season
- Keep it short — skip long intros, skip filler. Get to the products fast
...
- Never recommend anything not on the list above`;
  ...
  return (
    <div style={{display:'flex',flexDirection:'column',height:'100vh',fontFamily:"'Montserrat',sans-serif",background:'#FDF8F5',position:'relative',overflow:'hidden'}}>
        ...
        {messages.map((m,i) => {
          ...
          if (m.role === 'assistant') {
            return <AiMessage key={i} content={m.content}
              onMore={(isChatting && isLast) ? handleMore : null}
              onEnd={(isChatting && isLast) ? handleEndChat : null}
            />;
          }
      ...
      {showAdmin && <AdminPanel products={products} onSave={saveProducts} onClose={()=>setShowAdmin(false)}/>}
    </div>
  );
}

// ─── Message components ───────────────────────────────────────────────────────
function AiMessage({ content, isLast, onMore, onEnd }) {
  return (
